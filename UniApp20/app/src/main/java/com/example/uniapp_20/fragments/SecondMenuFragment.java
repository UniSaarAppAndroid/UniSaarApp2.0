...
public class SecondMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mensaSecondDate = view.findViewById(R.id.mensa_second_date);
        mensaSecondDate.setText(FrontEngine.getInstance().mensaSecondDate);
        getActivity().setTitle("Mensa Menu");
        mSwipeRefreshLayout = view.findViewById(R.id.mensa_second_swiperefresh_items);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.mensa_second_recycler_view);


        adapter = new MensaAdapter(view.getContext(), FrontEngine.getInstance().getMensaListSecond());

        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(view.getContext());
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new SecondMenuFragment.GridSpacingItemDecoration(1, dpToPx(0), true));
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Mensa mensa = FrontEngine.getInstance().getMensaListSecond().get(position);
